...
2. Owner: add PROD_SUPABASE_SERVICE_ROLE_KEY GitHub secret + deploy, then verify signup/reset emails arrive Epic-branded; tighten DMARC to quarantine after a few clean weeks.
